...
<!-- As a heading -->
<title>Data Bulan Desember</title>
<!-- Fontawesome -->
...
<div class="container-md align-middle">
	<div class="table-responsive " id="printableArea">
        ...
        <h5 class="text-center">- Seluruh data : Bulan Desember -</h5>
		...
		<div class="table-wrapper" id="table1">
          ...
          $output = $row['total'];
            ...
            $datatable ="SELECT * FROM data_history WHERE YEAR(tanggal) = YEAR(NOW()) AND MONTH(tanggal) IN (12) ORDER BY tanggal DESC LIMIT $halaman_awal, $batas";
