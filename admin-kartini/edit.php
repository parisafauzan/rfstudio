  ...
  <div class="m-3">
    ...
    <div class="m-3">
      ...
      <div class="p-2 mt-3 border">
        ...
        <?php }else if ($datalunas["cetak_foto"]== 'tidak ada' || $datalunas["cetak_foto"]== 'tidak ada '){?>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="hargaup" value="0" <?php echo ($datalunas["cetak_foto"]== 'tidak ada' || $datalunas["cetak_foto"]== 'tidak ada ' ) ?  "checked" : "" ;?> onclick="up5()">
              <label class="form-check-label" for="flexRadioDefault2">
              tidak ada
              </label>
          </div>
        ...
        <?php }else if ($datalunas["cetak_foto"]== 'bawaan silverprawedd' ||$datalunas["cetak_foto"]== 'bawaan silverprawedd '){?> 
          <div class="form-check">
            <input class="form-check-input" type="radio" name="hargaup" value="0" <?php echo ($datalunas["cetak_foto"]== 'bawaan silverprawedd' ||$datalunas["cetak_foto"]== 'bawaan silverprawedd ') ?  "checked" : "" ;?> onclick="up7()">
              <label class="form-check-label" for="flexRadioDefault2">
        ...
        <?php }else if($datalunas["cetak_foto"]== 'bawaan goldprawedd'||$datalunas["cetak_foto"]== 'bawaan goldprawedd '){ ?>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="hargaup" value="0" <?php echo ($datalunas["cetak_foto"]== 'bawaan goldprawedd' ||$datalunas["cetak_foto"]== 'bawaan goldprawedd ') ?  "checked" : "" ;?> onclick="up8()">
              <label class="form-check-label" for="flexRadioDefault2">
              bawaan goldprawedd
              </label>
          </div>
    ...
    <div class="ms-4 mt-5 me-4 mb-4 border p-3">
      ...
      <div class="tambah-anak ">
        ...
        <?php if ($datalunas["tipe_package"]=='best deal'||$datalunas["tipe_package"]=='special package'){?>
        ...
        <div class=" mt-4 mb-4">
          ...
          <div class="ms-3 mt-2">
            <div class="form-check mt-2">
                <input class="form-check-input" type="radio" value="250000" name="hargaovr" <?php echo (($datalunas["tipe_package"]=='special package'||$datalunas["tipe_package"]=='best deal')&&$datalunas["tambah_waktu"]== '1') ?  "checked" : "" ;?> onclick="myF()" >
                    <label class="form-check-label" for="flexRadioDefault2">
                      250k / jam
                    </label>
            </div>
            <div class="form-check mt-3">
                <input class="form-check-input" type="radio" value="150000" name="hargaovr" <?php echo (($datalunas["tipe_package"]=='special package'||$datalunas["tipe_package"]=='best deal')&&$datalunas["tambah_waktu"]== '30') ?  "checked" : "" ;?> onclick="myF1()">
                    <label class="form-check-label" for="flexRadioDefault2">
                      150k / 30 menit
                    </label>
            </div>
            <div class="form-check mt-3">
                <input class="form-check-input" type="radio" value="0" name="hargaovr" <?php echo (($datalunas["tipe_package"]=='special package'||$datalunas["tipe_package"]=='best deal')&&$datalunas["tambah_waktu"]== '0') ?  "checked" : "" ;?> onclick="myF2()">
                    <label class="form-check-label" for="flexRadioDefault2">
                      Hapus Overtime
                    </label>
            </div>
