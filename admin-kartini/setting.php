...
<!-- As a heading -->
<title>Setting - Bekasi Kota</title>
<!-- Fontawesome -->
        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                ...
                <div class="col pt-5 pb-4">
                    ...
                    <div class="">
                        <div class="row m-1 ">
                            <h2><i class="fa-solid fa-gear"></i> Setting -<b> Studio Kota</b></h2>
                        </div>
                        <div class="card ">
                                ...
                                <div class="card mb-3 ms-2 me-2 p-3">
                                    ...
                                    <div class="mt-4">
                                        <div class="row">
                                            ...
                                            <?php 
                                                $ambiljadwallibur = mysqli_query($koneksi,"SELECT * FROM jadwal_libur_kota");
                                                $no = 1;
                                                if(mysqli_num_rows($ambiljadwallibur)>0){
                                                    ...
                                                    ?>
                                                    <div class="card mx-auto text-center mt-3 p-3" style="max-width: 950px;">
                                                        <h5>Belum ada jadwal libur</h5>
                                                    </div>
                                                    <?php
                                                }
                                            ?>
