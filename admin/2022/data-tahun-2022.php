...
<div class="container-md align-middle table-responsive " >
    ...
    <?php //foreach ($data as $row ) :
          $saldo = "SELECT SUM(t.harga) as total FROM (SELECT harga,package FROM data_history_cobahampirfinishjuga WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '') UNION ALL SELECT harga,package FROM data_history WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '')) t";
        ...
        <div id="tabel1" style="font-size:12px;width:100%">
          <table id="" class="table tabel table-bordered table-hover mx-auto"  >
            ...
            <tbody>
              <?php 
              $data = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '') UNION SELECT * FROM data_history WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '') ORDER BY id DESC");
              $nomor = 1;
            ...
            <?php  
                  ...
                  // $amal = $d["harga"]*(0.025);
                  //////////////////////////////
                      $saldo1 = "SELECT SUM(t.harga) as total FROM (SELECT harga,tipe_package FROM data_history_cobahampirfinishjuga WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '') UNION ALL SELECT harga,tipe_package FROM data_history WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '')) t WHERE tipe_package = 'prawedding'";
                      ...
                      $saldo4 = "SELECT SUM(t.harga) as total FROM (SELECT * FROM data_history_cobahampirfinishjuga WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '') UNION ALL SELECT * FROM data_history WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '')) t WHERE package = 'cetak foto'";
          ...
          <div class="container-sm ">
            ...
            <div id="tabelPrint" hidden style="font-size:13px;width:100%">
                ...
                <tbody>
                    <?php 
                    $data = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '')  UNION ALL SELECT * FROM data_history WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '')  ORDER BY id DESC");
                    $nomor = 1;
                    while($d = mysqli_fetch_array($data)){
                    ?>
                    <tr >
...
<!-- Modal = ketika di klik masuk mode pop up -->
    <?php
    $ambildata = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '') UNION SELECT * FROM data_history WHERE tanggal LIKE '%2022%' AND (studio = 'Bekasi-Kabupaten' OR studio = '') ORDER BY id DESC");
