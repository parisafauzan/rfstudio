...
<div class="container-md align-middle table-responsive " >
    ...
    <?php //foreach ($data as $row ) :
          $saldo = "SELECT SUM(t.harga) as total FROM (SELECT harga,package FROM data_history_cobahampirfinishjuga WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') UNION ALL SELECT harga,package FROM data_history WHERE (studio = 'Bekasi-Kabupaten' OR studio = '')) t";
          ...
          $output = $row['total'];
					...
					// $data = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') UNION SELECT * FROM data_history  ORDER BY id DESC");
					// $jumlah_data = mysqli_num_rows($data);
					// $total_halaman = ceil($jumlah_data / $batas);

					// $data_konfirmasi = mysqli_query($koneksi,"SELECT * FROM data_history_cobahampirfinishjuga WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') UNION SELECT * FROM data_history ORDER BY id DESC LIMIT $halaman_awal, $batas");
            ...
            <div id="tabel1" style="font-size:12px;width:100%">
                ...
                <tbody>
                <?php 
                $data = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') UNION ALL SELECT * FROM data_history WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') ORDER BY id DESC");
                $nomor = 1;
                ...
                <?php }?>
                    ...
                    // $amal = $d["harga"]*(0.025);
                    //////////////////////////////
                        $saldo1 = "SELECT SUM(t.harga) as total FROM (SELECT harga,tipe_package FROM data_history_cobahampirfinishjuga WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') UNION ALL SELECT harga,tipe_package FROM data_history WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') ) t WHERE tipe_package = 'prawedding'";
                        //"SELECT package sum(harga) total FROM(SELECT package,harga FROM data_history_cobahampirfinishjuga union all select package,harga FROM data_history WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') ) group by totalan";
                        ...
                        $saldo2 = "SELECT SUM(t.harga) as total FROM (SELECT harga,package FROM data_history_cobahampirfinishjuga WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') UNION ALL SELECT harga,package FROM data_history WHERE (studio = 'Bekasi-Kabupaten' OR studio = '') ) t WHERE package IN ('self photo','studio')";
