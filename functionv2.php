...
// Izin harus dipilih secara eksplisit pada form booking. Nilai selain "1"
// disimpan sebagai tidak diizinkan agar aman untuk data dari form lama.
function bookingPublicationConsent($data){
    return (isset($data['izin_publikasi']) && (string)$data['izin_publikasi'] === '1') ? '1' : '0';
}
...
function bookingPublicationConsentField(){
    return '
      <div class="m-4">
        <fieldset>
          <legend class="form-label fw-bold mb-2" style="font-size:16px;">Izin publikasi konten<span class="text-danger">*</span></legend>
          <p class="text-black-50 mb-2" style="font-size:13px;">Apakah RF Studio diizinkan menggunakan foto atau video saat sesi pemotretan sebagai konten Story atau posting media sosial?</p>
          <div class="form-check mb-1">
            <input class="form-check-input" type="radio" name="izin_publikasi" id="izin-publikasi-ya" value="1" required>
            <label class="form-check-label" for="izin-publikasi-ya">Ya, saya mengizinkan.</label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="izin_publikasi" id="izin-publikasi-tidak" value="0">
            <label class="form-check-label" for="izin-publikasi-tidak">Tidak, saya tidak mengizinkan.</label>
          </div>
        </fieldset>
      </div>';
}

function detailLokasiStudio($studio){
...
function namaLokasiStudio($studio){
    if (empty($studio)) {
        return '-';
    }
...
function emailLokasiStudio($studio){
    if (empty($studio)) {
        return '';
    }
    $lokasi = detailLokasiStudio($studio);
...
$izinPublikasi = bookingPublicationConsent($data);
...
//urutan query sql = id,nama,notelp,email,package,harga(total),hargasetelahdp(total-dp),tanggal,jam,buktitf,buktilunas,jumlah(jenispaket),cetakfoto,nambahanak,nambahdewasa,nambahorang,nambahwaktu,tambahcetak,waktutransaksi(suksess isi data)
    ...
    $query = "INSERT INTO data_konfirmasi_cobahampirfinishjuga
                ...
                '$nambahorang',
                 ...
                 '$cetakfoto7$jumlahcetak7'
                 '$cetakfoto8$jumlahcetak8'
                 '$cetakfoto9$jumlahcetak9','$nambahhairdo','$nambahmakeup', '$waktuinput','$uniqid','$catatan','$jumlahorangdewasa','$jumlahoranganak','$studio','$izinPublikasi')";
...
<div class="card rf-box">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px; margin-top:20px;">
        ...
        <tr><td class="label">Lokasi Studio</td>
            <td class="value">'.namaLokasiStudio($studio).'</td></tr>
        '.emailLokasiStudio($studio).'

        <tr><td class="label">Izin Publikasi Konten</td>
            <td class="value">'.bookingPublicationConsentLabel($izinPublikasi).'</td></tr>
...
//urutan query sql = id,nama,notelp,email,package,harga(total),hargasetelahdp(total-dp),tanggal,jam,buktitf,buktilunas,jumlah(jenispaket),cetakfoto,nambahanak,nambahdewasa,nambahorang,nambahwaktu,tambahcetak,waktutransaksi(suksess isi data)
    ...
    $query = "INSERT INTO data_konfirmasi_cobahampirfinishjuga
                ...
                '$nambahorang',
                 ...
                 '$cetakfoto7$jumlahcetak7'
                 '$cetakfoto8$jumlahcetak8'
                 '$cetakfoto9$jumlahcetak9','0','0', '$waktuinput','$uniqid','$catatan','$jumlahorangdewasa','$jumlahoranganak','$studio','$izinPublikasi')";
...
//urutan query sql = id,nama,notelp,email,package,harga(total),hargasetelahdp(total-dp),tanggal,jam,buktitf,buktilunas,jumlah(jenispaket),cetakfoto,nambahanak,nambahdewasa,nambahorang,nambahwaktu,tambahcetak,waktutransaksi(suksess isi data)
     $query = "INSERT INTO data_konfirmasi_cobahampirfinishjuga
                ...
                '$harga' + ($nambahanak * 35000) + ($nambahdewasa * 50000) 
                + ($nambahorang * 15000) + ($nambahwaktu * 20000) 
                + (($cetakharga1 + $cetakharga2 + $cetakharga3 + $cetakharga4 + $cetakharga5) * 15000),
                0 ,
                '$date', 
                '$jam','$bukti_transfer',
                '$bukti_lunas','$jumlah','$cetakfoto',
...
mysqli_query($koneksi, "INSERT INTO data_tambahcetak VALUES(
                ...
                '$nama',
                '$uniqid',
                '$cetakharga1' * 15000,('$cetakharga2' * 15000),
                ('$cetakharga3' * 15000),('$cetakharga4' * 15000),
                ('$cetakharga5' * 15000),('$cetakharga6' * 0),
                ('$cetakharga7' * 0),('$cetakharga8' * 0),
                ('$cetakharga9' * 0),$cetakharga1, $cetakharga2,
                $cetakharga3,$cetakharga4,$cetakharga5,$cetakharga6,
                $cetakharga7,$cetakharga8,$cetakharga9,(($cetakharga1 + $cetakharga2 + $cetakharga3 + $cetakharga4 + $cetakharga5) * 15000), '$harga' + ($nambahanak * 35000) + ($nambahdewasa * 50000) 
                + ($nambahorang * 15000) + ($nambahwaktu * 20000) 
                + (($cetakharga1 + $cetakharga2 + $cetakharga3 + $cetakharga4 + $cetakharga5) * 15000) 
            )");
...
// $jumlahcetak = implode($arrayjumlah);
///
$cetakharga1 = isset($data["cetakharga1"]) ? (int)$data["cetakharga1"] : (isset($data["cetak4r"]) ? (int)$data["cetak4r"] : 0);
$cetakharga2 = isset($data["cetakharga2"]) ? (int)$data["cetakharga2"] : 0;
$cetakharga3 = isset($data["cetakharga3"]) ? (int)$data["cetakharga3"] : 0;
$cetakharga4 = isset($data["cetakharga4"]) ? (int)$data["cetakharga4"] : 0;
$cetakharga5 = isset($data["cetakharga5"]) ? (int)$data["cetakharga5"] : 0;
$cetakharga6 = isset($data["cetakharga6"]) ? (int)$data["cetakharga6"] : 0;
$cetakharga7 = isset($data["cetakharga7"]) ? (int)$data["cetakharga7"] : 0;
$cetakharga8 = isset($data["cetakharga8"]) ? (int)$data["cetakharga8"] : 0;
$cetakharga9 = isset($data["cetakharga9"]) ? (int)$data["cetakharga9"] : 0;
///
$cetakfoto1 = $cetakharga1 > 0 ? "4x6: " : "";
$cetakfoto2 = $cetakharga2 > 0 ? "3x4: " : "";
$cetakfoto3 = $cetakharga3 > 0 ? "2x3: " : "";
$cetakfoto4 = $cetakharga4 > 0 ? "Mix: " : "";
$cetakfoto5 = $cetakharga5 > 0 ? "Visa: " : "";
$cetakfoto6 = "";
$cetakfoto7 = "";
$cetakfoto8 = "";
$cetakfoto9 = "";
///
$jumlahcetak1 = $cetakharga1 > 0 ? $cetakharga1 . " template, " : "";
$jumlahcetak2 = $cetakharga2 > 0 ? $cetakharga2 . " template, " : "";
$jumlahcetak3 = $cetakharga3 > 0 ? $cetakharga3 . " template, " : "";
$jumlahcetak4 = $cetakharga4 > 0 ? $cetakharga4 . " template, " : "";
$jumlahcetak5 = $cetakharga5 > 0 ? $cetakharga5 . " template, " : "";
$jumlahcetak6 = "";
$jumlahcetak7 = "";
$jumlahcetak8 = "";
$jumlahcetak9 = "";
...
// $uniqid =htmlspecialchars ($data["uniqid"]);
$studio = isset($data["studio"]) ? htmlspecialchars($data["studio"]) : '';
...
//urutan query sql = id,nama,notelp,email,package,harga(total),hargasetelahdp(total-dp),tanggal,jam,buktitf,buktilunas,jumlah(jenispaket),cetakfoto,nambahanak,nambahdewasa,nambahorang,nambahwaktu,tambahcetak,waktutransaksi(suksess isi data)
     $query = "INSERT INTO data_konfirmasi_cobahampirfinishjuga
                ...
                0,0,0,0,
                 ...
                 '$cetakfoto7$jumlahcetak7'
                 '$cetakfoto8$jumlahcetak8'
                 '$cetakfoto9$jumlahcetak9','0','0', '$waktuinput','$uniqid','$catatan','$jumlahorangdewasa','$jumlahoranganak','','$izinPublikasi' )";
