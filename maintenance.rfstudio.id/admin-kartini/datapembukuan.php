...
<!-- As a heading -->
<title>Data Pembukuan - Bekasi Kota</title>
<!-- Fontawesome -->
    ...
    <div class="flex-wrap">
        <div class="pt-3">
            ...
            <div class="d-flex justify-content-between pb-4">
                ...
                <div class="logout">
                    <a href="logoutadmin.php" class="btn btn-outline-dark ms-1 align-items-center  text-decoration-none " onclick="return confirm('Anda yakin ingin keluar?')" style="font-size: 13px;">
                        <i class="fa-solid fa-right-from-bracket"></i>
                        <span class="d-none d-sm-inline mx-1 ms-2">Logout</span>
                    </a><br>
                </div>
            </div>
                <div class="d-flex mx-auto" style="max-width: 500px;">
                <div class="flex-fill text-end">
                    <a href="datapembukuan.php" type="button" class="btn btn-outline-dark active" style="width:100%;border-radius:0px">All data</a>
                </div>
                <div class="flex-fill text-end">
            ...
            <div class="container-md align-middle table-responsive " >
                <div id="printableArea">
                    ...
                    <?php //foreach ($data as $row ) :
                        $saldo = "SELECT SUM(t.harga) as total FROM (SELECT harga,package FROM data_history_cobahampirfinishjuga WHERE studio = 'Bekasi-Kota' UNION ALL SELECT harga,package FROM data_history WHERE studio = 'Bekasi-Kota') t";
                        ...
                        $output = $row['total'];
                                    ...
                                    // $data = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga WHERE studio = 'Bekasi-Kota' UNION SELECT * FROM data_history  ORDER BY id DESC");
                                    // $jumlah_data = mysqli_num_rows($data);
                                    // $total_halaman = ceil($jumlah_data / $batas);

                                    // $data_konfirmasi = mysqli_query($koneksi,"SELECT * FROM data_history_cobahampirfinishjuga WHERE studio = 'Bekasi-Kota' UNION SELECT * FROM data_history ORDER BY id DESC LIMIT $halaman_awal, $batas");
                                    // $nomor = $halaman_awal+1;?>
                            <div id="tabel1" style="font-size:12px;width:100%">
                                    <table id="tabel" class="table table-bordered table-hover mx-auto"  >
                                ...
                                <tbody>
                                <?php 
                                $data = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga WHERE studio = 'Bekasi-Kota' UNION ALL SELECT * FROM data_history WHERE studio = 'Bekasi-Kota' ORDER BY id DESC");
                                $nomor = 1;
                                ...
                                <?php }?>
                                    ...
                                    // $amal = $d["harga"]*(0.025);
                                    //////////////////////////////
                                        $saldo1 = "SELECT SUM(t.harga) as total FROM (SELECT harga,tipe_package FROM data_history_cobahampirfinishjuga WHERE studio = 'Bekasi-Kota' UNION ALL SELECT harga,tipe_package FROM data_history WHERE studio = 'Bekasi-Kota' ) t WHERE tipe_package = 'prawedding'";
                                        //"SELECT package sum(harga) total FROM(SELECT package,harga FROM data_history_cobahampirfinishjuga union all select package,harga FROM data_history WHERE studio = 'Bekasi-Kota' ) group by totalan";
                                        ...
                                        $saldo2 = "SELECT SUM(t.harga) as total FROM (SELECT harga,package FROM data_history_cobahampirfinishjuga WHERE studio = 'Bekasi-Kota' UNION ALL SELECT harga,package FROM data_history WHERE studio = 'Bekasi-Kota' ) t WHERE package IN ('self photo','studio')";
                                        ...
                                        $saldo4 = "SELECT SUM(t.harga) as total FROM (SELECT * FROM data_history_cobahampirfinishjuga WHERE studio = 'Bekasi-Kota' UNION ALL SELECT * FROM data_history WHERE studio = 'Bekasi-Kota') t WHERE package = 'cetak foto'";
                            ...
                            <div id="tabelPrint" hidden style="font-size:13px;width:100%">
                                ...
                                <tbody>
                                    <?php 
                                    $data = mysqli_query($koneksi, "SELECT * FROM data_history_cobahampirfinishjuga  UNION ALL SELECT * FROM data_history  ORDER BY id DESC");
                                    $nomor = 1;
                                    while($d = mysqli_fetch_array($data)){
                                    ?>
                                    <tr >
                                ...
                                <?php  
                                        ...
                                        // $amal = $d["harga"]*(0.025);
                                        //////////////////////////////
                                            $saldo1 = "SELECT SUM(t.harga) as total FROM (SELECT harga,tipe_package FROM data_history_cobahampirfinishjuga  UNION ALL SELECT harga,tipe_package FROM data_history ) t WHERE tipe_package = 'prawedding'";
                                            //"SELECT package sum(harga) total FROM(SELECT package,harga FROM data_history_cobahampirfinishjuga union all select package,harga FROM data_history WHERE studio = 'Bekasi-Kota' ) group by totalan";
                                            $total1 = mysqli_query($koneksi,$saldo1);
                                            while($row1 = mysqli_fetch_assoc($total1)){
                                            $output1 = $row1['total']-(($row1['total']*0.6)+($row1['total']*0.025));
                                            ...
                                            $saldo2 = "SELECT SUM(t.harga) as total FROM (SELECT harga,package FROM data_history_cobahampirfinishjuga  UNION ALL SELECT harga,package FROM data_history ) t WHERE package IN ('self photo','studio')";
                                            $total2 = mysqli_query($koneksi,$saldo2);
                                            while($row2 = mysqli_fetch_assoc($total2)){
                                            $output2 = $row2['total']-($row2['total']*0.025);
                                            $outputamal2 = ($row2['total']*0.025) ;
                                            ...
                                            $saldo3 = "SELECT SUM(t.harga) as total FROM (SELECT harga,package,tipe_package FROM data_history_cobahampirfinishjuga  UNION ALL SELECT harga,package,tipe_package FROM data_history ) t WHERE tipe_package IN ('best deal','special package','diamond package','baby best deal','baby special package')";
                                            $total3 = mysqli_query($koneksi,$saldo3);
                                            while($row3 = mysqli_fetch_assoc($total3)){
                                            $output3 = $row3['total']-(($row3['total']*0.2)+($row3['total']*0.025));
                                            $outputamal3 = ($row3['total']*0.025) ;
                                            ...
                                            $saldo4 = "SELECT SUM(t.harga) as total FROM (SELECT * FROM data_history_cobahampirfinishjuga  UNION ALL SELECT * FROM data_history ) t WHERE package = 'cetak foto'";
                                            $total4 = mysqli_query($koneksi,$saldo4);
                                            while($row4 = mysqli_fetch_assoc($total4)){
                                            $output4 = $row4['total']-(($row4['total']*0.34)+($row4['total']*0.025));
                                            $outputamal4 = ($row4['total']*0.025) ;
