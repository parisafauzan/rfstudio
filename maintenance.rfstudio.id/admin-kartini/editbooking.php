...
$datalunas = query("SELECT * FROM data_booking_cobahampirfinishjuga WHERE id = '$id'")[0]; 
		...
		<div class="table-wrapper">
            ...
            <th style="width: 20%;">Jam</th>
				...
				<tbody>
					...
					$data = mysqli_query($koneksi, "SELECT nama,package,tanggal,jam,tipe_package FROM data_booking_cobahampirfinishjuga WHERE studio IN ('Bekasi-Kabupaten','') UNION SELECT nama,package,tanggal,jam,tipe_package FROM data_booking_cobahampirfinishjuga WHERE studio IN ('Bekasi-Kabupaten','') ORDER BY tanggal,jam ASC");
					$jumlah_data = mysqli_num_rows($data);
					$total_halaman = ceil($jumlah_data / $batas);

					$data_konfirmasi = mysqli_query($koneksi,"SELECT nama,package,tanggal,jam,tipe_package FROM data_booking_cobahampirfinishjuga WHERE studio IN ('Bekasi-Kabupaten','') UNION SELECT nama,package,tanggal,jam,tipe_package FROM data_booking_cobahampirfinishjuga WHERE studio IN ('Bekasi-Kabupaten','') ORDER BY tanggal,jam ASC LIMIT $halaman_awal, $batas");
