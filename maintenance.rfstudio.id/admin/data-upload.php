...
<!-- As a heading -->
<title>Data Foto Upload - Bekasi Kabupaten</title>
<!-- Fontawesome -->
        ...
        <div class="col-auto  px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-1 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0  align-items-center align-items-sm-start" id="menu">
                    <li >
                        <a href="#" class="nav-link px-0 mt-2 align-middle text-white" style="font-size: 16px;" >
                        <i class="fa-solid fa-list-check m-2 "></i> <span class=" me-2 d-none d-sm-inline">Nunggu Konfirmasi</span> </a>
                    </li>
                    <li>
                        <a href="data-upload.php" class="nav-link px-0 mt-2 align-middle text-white" style="background-color:black ; font-size: 16px;" >
		...
		<div class="table-wrapper">
          ...
          <?php //foreach ($data as $row ) :
              ...
              <td class="align-middle"><?php
               ...
               ?></td>
              <td class="align-middle"><?php echo $d["package"];echo " ";echo  '<b>'.$d["tipe_package"];'</b>'  ?> </td>
              <td hidden><?php 
              if($d["package"] == 'cetak foto'){
                echo '--';
              }else{
             ...
             if ($d["package"] == 'self photo' && $d["tambah_waktu"] > 0)
              ...
              <td class="align-middle text-center"><?php 
                        $uniqid= $d["uniqid"];
                        $statusfoto = mysqli_query($koneksi,"SELECT * FROM data_upload_foto_studio_admin WHERE uniqid_client = '$uniqid' LIMIT 1");
                        $resultstatus = mysqli_fetch_assoc($statusfoto);
                          if($resultstatus && $resultstatus["uniqid_client"] > 0){
                            ?>
                            <i class="fa-solid fa-cloud-arrow-up" style="color:#239c02;"></i>
                            <span class="d-none d-md-inline" style="color:#239c02;"> upload</span>
                            <?php
                          }else{?>
                            <i class="fa-solid fa-file-circle-xmark" style="color:#ad001a"></i>
                            <span class="d-none d-md-inline" style="color:#ad001a"> belum upload</span>
                          <?php }  ?></td>
              ...
              <td>
                <button type="button" style="font-size: 13px;" class="btn btn-success viewdata ms-2 mt-1" id="viewdata" >
                  Detail</button>
                <a href="upload-foto.php?uniqid=<?= $d["uniqid"]; ?>"  style="font-size: 13px;" class="btn btn-warning ms-2 mt-1 text-dark" name="tombol_konF" >
                    Upload Foto</a>
