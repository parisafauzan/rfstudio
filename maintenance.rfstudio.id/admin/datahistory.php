...
<!-- As a heading -->
<title>Data History - Bekasi Kabupaten</title>
<!-- Fontawesome -->
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title ">
				<div class="row m-1 ">
					<h2>Data<b>Pelanggan </b></h2> </b><a href="datapembukuan.php" type="button" class="text-dark mt-3 mb-3 " style="max-width:200px;margin-left:100px;font-size: 20px; margin-left: auto;">Lihat Pembukuan</a></h2>
			...
			<table class="table table-hover table-bordered" id="tabel">
              ...
              <th class="tengah" style="width: 10%;">Waktu Transaksi</th> 
				...
				<tbody >
					...
					$data_konfirmasi = mysqli_query($koneksi,"SELECT * FROM data_history WHERE studio IN ('Bekasi-Kabupaten','') UNION SELECT * FROM data_history_cobahampirfinishjuga WHERE studio IN ('Bekasi-Kabupaten','') ORDER BY id DESC ");
