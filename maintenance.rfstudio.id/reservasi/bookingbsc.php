      ...
      <form id="myForm"  method="post" action="" enctype="multipart/form-data">
        <div class="m-4  ">
          ...
          <input type="text" class="form-control" id="buktilunas" name="buktilunas" value="0" hidden>
            <label  class="form-check-label  ms-3">Transfer ke Bank <i>BCA</i> <p> 5780785057 A.n. Rizal Satria Agung</p><h class="text-black-50" style="font-size: 14px;">(*jumlahkan dengan penambahan apabila ada penambahan)</h></label>
