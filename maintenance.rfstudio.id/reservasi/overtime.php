...
<section class="m-3 containertr"  id="containertr" >
  <?php
    if (isset($_GET['bsubmit'])){
      ...
      $sql = mysqli_query($koneksi,"SELECT * FROM data_booking_cobahampirfinishjuga WHERE uniqid = '$track'");
    ...
    //  var_dump($_POST);
      ...
      //echo '<meta http-equiv="refresh" content="3;url=../index.php">';
        ...
        echo '<script language="javascript">';
        echo 'function alert("Data gagal terkirim") {';
        echo 'document.getElementById("myForm").reset()};';
  ...
  <div class="d-inline-flex ps-1 pe-1 text-white bg-dark " style="width: 200px; height: 60px; " > 
      <h5 class="product-title text-center mt-3 mx-auto">Overtime</h5></div>
...
<form id="myForm" method="post" action="" enctype="multipart/form-data">
  <div class="m-3">
    ...
    <input type="hidden"  class="form-control"  id="harga" name="harga" value="<?= $ambil["harga"];  ?>">
    <input type="hidden"  class="form-control"  id="hargasdp" name="hargasdp" value="<?= $ambil["hargasetelahdp"];  ?>">
    <!-- <input type="hidden"  class="form-control"  id="waktu" name="waktu" value="<?= $ambil["waktu"];  ?>"> -->
    <div class="ms-3 mt-4">
      <p class="fw-bold">Pilihan<span class="text-black-50"> (Perpanjangan Waktu)</span></p>
      <div class="ms-3 mt-2">
        <div class="form-check mt-2">
            <input class="form-check-input" type="radio" value="250000" name="hargaovr" onclick="myFunction()"  required>
                <label class="form-check-label" for="flexRadioDefault2">
                  250k / jam
                </label>
        </div>
         <div class="form-check mt-3">
            <input class="form-check-input" type="radio" value="150000" name="hargaovr" onclick="myFunction1()"  required>
                <label class="form-check-label" for="flexRadioDefault2">
                  150k / 30 menit
                </label>
        </div>
     ...
     <input class="form-control" type="text" value="0" name="waktuovr" id="waktuovr" >

    <div class="ms-3 mt-5">
      <p  class="form-check-label  mt-3">Transfer ke Bank <i>BCA</i> <p> 5780785057 A.n. Rizal Satria Agung</p></p>
    </div>
    <div class="m-3">
      <label for="upload-img" class="mb-3 mt-4 fw-bold">Upload Bukti Transfer (Perpanjangan Waktu)</label>
      <p class="text-black-50" >
            *ukuran max 5 MB</p>
            <p class="text-black-50 ">
            *format gambar .png/.jpg/.jpeg </p>
            <p class="text-black-50 ">
            jika pembayaran via uang tunai, konfirmasi ke admin dan upload screenshoot chat dengan admin
          
         
    <div class="elem-group inlined">
        <!-- img -->
      <input type="file" class="mb-4" id="buktiovr" name="buktiovr" value="" required onchange="preview()"> 
      ...
      <button  type="submit" name="submitovr" class="btn-lg btn-outline-dark m-4 justify-content-center">Submit</button>
    </form>
        ...
        <div class="row text-start text-md-left"> 
          ...
          <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3">
            ...
            <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3">
              ...
              <i class="fas fa-location-dot me-2"></i>Rizal Foto Studio 
              </a>
              </p>
              <p>
              ...
              <p>
                <a href="../admin/adminlogin.php" class="fadmin " style="text-decoration: none; color:#fff;">
            ...
            <div class="row align-items-center">
              <div class="col-md-6 col-lg-6 ">
                <p class="text-start"> Copyright ©2022 All rights reserved by :
