...
$hapusjamsementara = $jadwal['id'];
  ...
  if(tambah($_POST)>0){
      ...
      echo '<script language="javascript">';
      echo 'window.location = "booking-babysmash.php";';
      echo '</script>';
    }exit;
  }
?>
 ...
 <!-- Favicons -->
  ...
  <body>
    ...
    <style type="text/css">
      ...
      .modal-overlay {
        display: flex; /* langsung tampil saat halaman dibuka */
        position: fixed;
        top: 0; left: 0;
  ...
  <div class="mb-4 mt-4 mx-auto text-center" >
    <div class="m-2 ">
      ...
      <div class="d-flex mx-auto mb-2 mt-4" style="max-width: 700px;">
        ...
        <div class="flex-fill">
          <a href="../kategori/maternitypackage.php" type="button" class="btn btn-outline-dark" style="width:100%;border-radius:0px;font-size:14px;">Maternity Package</a>
        </div>
        <div class="flex-fill">
        ...
        <div class="flex-fill">
          <a href="../kategori/graduationpackage.php" type="button" class="btn btn-outline-dark" style="width:100%;border-radius:0px;font-size:14px;">Graduation Package</a>
        </div>
        <div class="flex-fill">
          <a href="../kategori/baby-smash-cake.php" type="button" class="btn btn-outline-dark" style="width:100%;border-radius:0px;font-size:14px;">Baby Birthday / Smash Cake Package</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <form id="myForm" method="post" action="" enctype="multipart/form-data">
      <div class="jarak  ">
          ...
          <div class="col-md-5 ms-4">
            <div class="row">
              <div class="col mt-3 p-2">
                ...
                <input class="form-check-input" type="radio" value="baby smash cake" name="package" id="babysmash-package" onclick="myFunction5()" required checked hidden>
                    <label class="form-check-label " for="flexRadioDefault2" style="font-size: 16px;">
            ...
            <div class="col border mt-3 p-2">
              <div class="form-check mt-2">
                <input class="form-check-input sp" type="radio" value="1250000" name="harga" id="mySelect2" onclick="org1()" required>
                <label class="form-check-label" for="flexRadioDefault2">
                <b>SPECIAL PACKAGE</b><span class="fw-light text-danger">*</span> <label class="text-decoration-line-through text-black-50"> 1399k</label> 1250k
                </label>
                <!-- <input class="form-check-input" type="text" name="cetakfoto" hidden> -->
                  <p class="" style="font-size:small;">1 Photographer</p>
                  <p class="" style="font-size:small;">1 jam Photo Session</p>
                  <p class="" style="font-size:small;">Sudah termasuk Photographer</p>
                  <p class="" style="font-size:small;">Include Simple Decoration</p>
                  <p class="text " style="font-size:small;">1 cetak Canvas + Frame ukuran 17R / kalau sudah di pasang frame ukurannya 40cm x 50 cm</p>
                  <p class="text " style="font-size:small;">5 pcs cetak ukuran 5R (tanpa frame)</p>
                  <p class="text " style="font-size:small;">Free 10-20 Photo, edit tone warna</p>
                  <p class="text " style="font-size:small;">Foto unlimited / sepuasnya</p>
                  <p style="font-size:small;">All Softcopy on Google drive<b><br> (berlaku 2 Minggu)</b></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class=" bs-package p-2" >
              <div class="col border p-2">
                <div class="form-check mt-2" >
                  <input class="form-check-input bsd" type="radio" value="950000" name="harga" id="mySelect1" onclick="org()" required>
                  <label class="form-check-label" for="flexRadioDefault2">
                  <b>BEST DEAL PACKAGE</b><span class="fw-light text-danger">*</span> <label class="text-decoration-line-through text-black-50"> 999k</label> 950k
                  </label>
                  <!-- <input class="form-check-input" type="text" name="cetakfoto" hidden> -->
                    <p class="" style="font-size:small;">1 Photographer</p>
                    <p class="" style="font-size:small;">1 jam Photo Session</p>
        ...
        <div class="jarak">
          ...
          <p class="text-black-50 ms-3">*Pelunasan dilakukan H-1 dari tanggal yang dipesan ya kak</p>
        </div>
          ...
          <div class="modal-body">   
              <div class="container">
                <ul>
                  ...
                  <li>Reshedule paling lambat H-1 <b>Cancel</b> hari H dp hangus</li>
                  <li><b>Pelunasan paling lambat H-1</b> sebelum sesi foto</li>
...
<!-- Ini adalah awal footer  -->
  ...
  <div class="modal-overlay" id="modalOverlay">
    <div class="modal-popup">
      <p>Hai kak! 👋<br>
Jangan lupa ya, pelunasan dilakukan paling telat H-1 sebelum sesi foto,<br> biar semuanya jalan lancar dan bisa kasih hasil yang maksimal 💅<br>
Jadi pas hari H tinggal senyum, gaya, dan klik! 📸✨</p>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // (Opsional) Klik di luar modal tidak menutup supaya tetap blok layar
    });
    </script>
 ...
 function org() {
  $('#cetak').val('tidak ada');
  $('#jumlah').val('baby best deal');
 }
 function org1() {
  $('#cetak').val('bawaan baby specialpackage');
  $('#jumlah').val('baby special package');
 }
 function org2() {
  $('#cetak').val('bawaan baby diamondpackage');
  $('#jumlah').val('baby diamond package');
 }
</script>
 <script>
    function myF(){
