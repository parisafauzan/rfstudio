      ...
      <form id="myForm"  method="post" action="" enctype="multipart/form-data">
        <div class="m-4  ">
          ...
          <div >
            ...
            <input type="text" class="form-control" id="ketbayar" name="ketbayar" value="untuk memastikan silahkan hubungi admin via Whatsapp" hidden>
            <!--------------------------------------------->
          <!----------------------------------------------------------------->
            ...
            <div class="col-md-5">
              ...
              <div class="border bmg-package p-2 mt-3" >
                <div class="form-check mt-2">
                  ...
                  <b>BASIC PACKAGE</b> (Pas Foto, CV, Visa) 40k
                  </label>
          ...
          <div class="col-md-5 mt-3">
            ...
            <div class="border bmg-package p-2 mt-3" >
                <div class="form-check mt-2">
                  <input class="form-check-input" type="radio" value="180000" name="harga" onclick="org2()" id="mySelect3b" required>
                  <label class="form-check-label" for="mySelect3b">
                  <b>PAS FOTO NIKAH FORMAL + GAYA BEBAS</b> 180k
                  </label>
                  <div style="font-size: 15px;">
                    <p style="font-size:small;margin-top:10px;">2 person</p>
                    <p style="font-size:small;"><b>Sesi Formal:</b></p>
                    <p style="font-size:small;">Photographer</p>
                    <p style="font-size:small;">3 - 4 kali take foto / person</p>
                    <p style="font-size:small;">2 file edit</p>
                    <p style="font-size:small;">Cetakan 2x3, 3x4, 4x6 (@6 lmbr)</p>
                    <p style="font-size:small;"><b>Sesi Gaya Bebas:</b></p>
                    <p style="font-size:small;">Self Photo 10 menit (Tanpa Photographer)</p>
          ...
          <div class="jarak ms-5 mt-3">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="latar" id="latarputih" value="Putih" required>
              <label class="form-check-label" for="latarputih">Latar Putih</label>
            </div>
          </div>
          ...
          <div class="d-flex flex-row"> 
          ...
          </div> <!-- Tutup id="nambah" agar opsi di bawahnya tidak ikut tersembunyi (display:none) -->
            
                <!-- Opsi cetak foto lama disembunyikan; gunakan pilihan ukuran pas foto di bawah. -->
            <div class="form-check">
            ...
            <input type="text" name="cetakfoto9"  autocomplete="off"  class="form-control  text-center" id="box9" hidden>
              ...
              <div class="jarak ms-5 mb-3">
                ...
                <input type="hidden" name="cetakharga7" value="0">
                <input type="hidden" name="cetakharga8" value="0">
                <input type="hidden" name="cetakharga9" value="0">
              </div>
              <div class="row mb-4">
      ...
      <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">   
              <div class="container">
                <ul>
                  <li>Link google drive dikirim setelah sesi foto dan hanya berlaku 2 minggu</li>
                  <li>Datang 10 - 15 menit sebelum sesi foto</li>
                  <li>Sesi foto sesuai jam bookingan, jika telat akan di ganti ke sesi berikutnya yg kosong</li>
                  <li>Reshedule paling lambat H-1</li>
                  <li>Kita ada 2 lokasi studio pastikan anda sudah booking di lokasi yg benar</li>
                  <li>Editing mencangkup coloring, memperbaiki background &amp; menghilangkan jerawat</li>
                  <li>Payment setelah sesi foto bisa cash / Qris</li>
                </ul>
              </div>
          </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
 ...
 function org2() {
  $('#jumlah').val('nikah-formal-gaya-bebas');
  $('#jumlahorangdewasa').val(2);
  $('#jumlahorangdewasa').prop('readonly',true);
 }
</script>
