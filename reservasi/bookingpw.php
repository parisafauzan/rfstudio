...
<html lang="en">
 ...
 <!-- Favicons -->
  ...
  <link href="../img/logo.png" rel="apple-touch-icon">
    ...
    <!-- As a heading -->
    <title>Booking Prawedding</title>
    <!-- Fontawesome -->
    ...
    <div class="m-2 ">
      ...
      <div class="mx-auto mb-2 mt-4" style="max-width: 400px;">
        <div class="flex-fill mb-4" >
          <a href="../kategori/spraweddingpackage.php" type="button" class="btn btn-outline-dark" style="width:100%;border-radius:0px;font-size:15px;">
          <div class="d-flex">
            <img class="shadow-lg me-4" src="../img/fotoSilverPrawedding.png" width="60" style="border-radius: 10px;">
            <label class="my-auto ms-3"> Silver Prewedding Package</label>
          </div>
          </a>
        </div>
        <div class="flex-fill mb-4" >
          <a href="../kategori/gpraweddingpackage.php" type="button" class="btn btn-outline-dark" style="width:100%;border-radius:0px;font-size:15px;">
          <div class="d-flex">
            <img class="shadow-lg me-4" src="../img/fotoGoldPrawedding.png" width="60" style="border-radius: 10px;">
            <label class="my-auto ms-3"> Gold Prewedding Package</label>
          </div>
          </a>
        </div>
        <div class="flex-fill">
    ...
    <form id="myForm"  method="post" action="" enctype="multipart/form-data">
      <div class="formjarak">
        <div class="jarak">
          ...
          <input type="text"  class="form-control" id="cetak" name="cetak" value="" autocomplete="off" hidden >
          ...
          <label for="nomer" class="form-label fw-bold">Pilih Package<span class="text-danger">* </span><label class="text-black-50"> wajib diisi </label></label>
            ...
            <input class="form-control bsd" type="text" id="harga" name="harga" hidden>
          ...
          <div class="row row-md-5  jarak">
            ...
            <div class="border gs-package p-2 mt-3" >
                <div class="form-check mt-2">
                  <input class="form-check-input package-btn" type="radio" value="gold" name="package" id="gold-package" onclick="myFunction2()" data-dp="500" required>
                  <label class="form-check-label" for="flexRadioDefault2">
                  <b>GOLD PACKAGE PRAWEDDING</b> <label class="text-decoration-line-through text-black-50"> 2199k</label> 1850k
                  </label>
                  <div style="font-size: 15px;">
                    <p class="" style="font-size:small;margin-top:10px;">1 Photographer</p>
                    <p class="" style="font-size:small;">2 Background Photo</p>
                    <p class="" style="font-size:small;">1-1.5 Jam Makeup</p>
                    <p class="" style="font-size:small;">1 Jam Photo Session</p>
                    <p class="" style="font-size:small;">2 Cetak uk 30 x 40 + Frame</p>
                    <p class="" style="font-size:small;">Free 15-20 Photo, edit tone warna</p>
                    ...
                    <p class="" style="font-size:small;">Include Makeup + Busana</p>
          ...
          <div class="border gs-package p-2 mt-3" >
          <div class="form-check mt-2">
                  <input class="form-check-input package-btn" type="radio" value="silver" name="package" id="silver-package" onclick="myFunction2a()" data-dp="200" required>
                  <label class="form-check-label" for="flexRadioDefault2">
                  <b>SILVER PACKAGE PRAWEDDING</b> <label class="text-decoration-line-through text-black-50"> 1199k</label> 900k
                  </label>
                  <div style="font-size: 15px;">
                    <p class="" style="font-size:small;margin-top:10px;">1 Photographer</p>
                    <p class="" style="font-size:small;">2 Background Photo</p>
                    <p class="" style="font-size:small;">1 Jam Photo Session</p>
                    <p class="" style="font-size:small;">2 Cetak uk 17R + frame</p>
                    <p class="" style="font-size:small;">Free 20 Photo, edit tone warna / retouch wajah</p>
                    <p class="" style="font-size:small;">Unlimited Photo</p>
                    <p class="" style="font-size:small;">All Softcopy on Google drive<b><br> (berlaku 2 Minggu)</b></p>
          ...
          <div class="jarak ">
                <div class="form-check mt-2" >
                  <input class="form-control bsd" type="text" value="prawedding"  name="jumlah" id="duaorg"  hidden>
            </div>    
            </div>
            ...
            <div class="row">
              <div class="col">
                <input type="text"  class="form-control"  id="jam" name="jam"  autocomplete="off" value="<?php echo $jadwal["jam"]?>" readonly>
                   <!-- <input type="text"  class="form-control"  id="jamemail" name="jamemail"  autocomplete="off" value="<?php 
                  if($jadwal["jam"]=="08:00-09:00 09:30-10:30"){
                    echo "08:00-10:00";
                  }else if($jadwal["jam"]=="11:00-12:00 12:30-13:30"){
                  echo "11:00-13:00";
                  }
                  else if($jadwal["jam"]=="14:00-15:00 15:30-16:30"){
                  echo "14:00-16:00";
                  }
                  else if($jadwal["jam"]=="17:00-18:00 18:30-19:30"){
                  echo "17:00-19:00";
                  }
                    else if($jadwal["jam"]=="20:00-21:00 21:00-22:00"){
                  echo "20:00-22:00";
                  }?>" readonly> -->
            <!-- <div class="elem-group inlined"> 
          ...
          <div class="jarak ms-5" hidden>
            ...
            <div class="row" style="max-width:200px;">
              ...
              <div class="col input">
                <input type="tel" style="max-width: 50px;"  class="form-control"  id="jumlahorangdewasa" name="jumlahorangdewasa" value="2" placeholder="" minlength="1" maxlength="2"  autocomplete="off" required>
              </div>
            </div>
            ...
            <div class="row" style="max-width:200px;">
              ...
              <div class="col input">
                <input type="tel" style="max-width: 50px;"  class="form-control"  id="jumlahoranganak" name="jumlahoranganak" value="0" placeholder="" minlength="1" maxlength="2"  autocomplete="off" required>
              </div>
            </div>
          </div>
          ...
          <div class="row row-sm-5 row-md-5 row-lg-5 border mx-auto" hidden id="nambah" style="justify-content: center;">
          ...
          <div class="m-3 border  ">
            <label for="upload-img" class="text-center m-3 fw-bold">Jumlah orang</label>
            <div class="container" id="jumlah-anak" >
            <div class="row">
              <div class="col-sm-3 m-3">
                  <div class="input-group" style="width: 130px;" >
                    ...
                    <button type="button" class="btn btn-default btn-orang-minus"  data-type="minus" data-field="quant[1]" >
                      ...
                      <input type="text" name="nambahorang" style="background-color: white;"  autocomplete="off" placeholder="0" class="form-control input-nambah-number text-center" value="0" min="0" max="8" hidden>
          ...
          <div class="text-center ">
                <label class="form-check-label" for="flexCheckDefault">
                Tambah waktu (20k/5 menit)
                </label>
            </div>
            <!-- nambahorang Dewasa -->
            
          <div class=" m-3 border  ">
            <label for="upload-img" class="text-center m-3 fw-bold">Jumlah menit</label>
            <div class="container jumlah-orang">
            <div class="row">
              <div class="col-sm-3 m-3">
                  <div class="input-group" style="width: 130px;">
                      <span class="input-group-btn">
                    <button type="button" class="btn btn-default btn-minus"  data-type="minus" data-field="quant[1]">
                      ...
                      <input type="text" name="nambahdewasa" style="background-color: white;" autocomplete="off" placeholder="0" class="form-control input-gede-number text-center" value="0" min="0" max="8" hidden>
                      <input type="text" name="nambahwaktu" style="background-color: white;" autocomplete="off" placeholder="0" class="form-control input-waktu-number text-center" value="0" min="0" max="100" hidden>
                      <p type="text" name="nambahwaktu1" id="nambahwaktu1"  style="background-color: white; height:37px" autocomplete="off" placeholder="0" class="form-control input-gede-number text-center" value="0" min="0" max="100" readonly>0</p>
          ...
          <div class="jarak">
            <div class="ms-2 mt-4 mb-2 border p-2">
              <p class="fw-bold">Tambah Waktu<span class="text-black-50"> (Perpanjangan Waktu) *<span style="font-size: 13px;">abaikan jika tidak ada penambahan</span></span></p>
              <div class="ms-3 mt-2">
              <?php
              // <div class="form-check mt-2">
          ...
          <div class="text-center">
            <button type="submit" name="submit" class="btn btn-lg btn-outline-dark mt-2 mb-5" id="submit" onclick="alert()" >Booking</button>
            </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">   
              <div class="container">
                <ul>
                  <li>Untuk booking / reservasi harap membayar DP, pelunasan setelah sesi foto ( cancel dp hangus )</li>
     ...
     <!-- Modal Pop-up -->
      <div class="modal-overlay" id="modalOverlay">
        <div class="modal-popup">
          <p>Hai kak! 👋<br> mau ngingetin nih khusus <b>Gold Prawedding Package</b> DP-nya <br>
          <b>500rb</b> ya kak <br>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
  ...
  <script>
      document.addEventListener('DOMContentLoaded', function() {
        const openModal = document.getElementById('gold-package');
      ...
      $(document).ready(function(){
        $('.btn-plus').click(function (e){
          ...
          if(value < 8){
            ...
            document.getElementById("calculation").innerHTML = myFunction(value, 35000);
        ...
        $('.btn-minus').click(function (e){
          ...
          if(value > 1){
            value--;
            $('.input-number').val(value);
             document.getElementById("calculation").innerHTML = myFunctionn((value*35000), 0);
